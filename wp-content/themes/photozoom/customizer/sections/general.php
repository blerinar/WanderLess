        ...
        'options'   => array(
            ...
            'photozoom-featured-page-1'  => array(
                ...
                'control'               => array(
                    ...
                    'description'       => sprintf( wp_kses( __( 'This list is populated with <a href="%1$s">Pages</a>.', 'photozoom' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'edit.php?post_type=page' ) ) ),
                    'type'              => 'select',
