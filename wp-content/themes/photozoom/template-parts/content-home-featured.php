					...
					?><li <?php post_class($classes); ?>>
						<div class="site-column-widget-wrapper clearfix">
							...
							<div class="entry-thumbnail">
								...
								<h2 class="entry-title"><span class="entry-title-span"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'photozoom' ), the_title_attribute( 'echo=0' ) ); ?>"><?php the_title(); ?></a></span></h2>
