<?php
/**
 * The template used for displaying the latest photozoom episode on the Front Page.
 *
 * @package Photozoom
 */
?>
...
<?php
	...
	$featured_category = get_theme_mod( 'photozoom-episodes-category' , 1 );
	$featured_label = get_theme_mod( 'photozoom-episodes-label' , esc_html__( 'Newest Episode', 'photozoom' ) );
