<div class="wrapper-content-block">
	<div class="wrapper-content-align">
		...
		<div class="post-single">
			...
			<p><strong><?php esc_html_e( 'Thank you for installing Photozoom Theme', 'photozoom' ); ?></strong></p>
			<p>You are now ready to start setting up your new website using our theme.
			<br>If you need help, please check out the <a href="https://www.ilovewp.com/documentation/photozoom/">Photozoom Documentation Page</a> first.
			...
			<p>In short, here's what you need to do in order to have a website like <a href="http://demo.ilovewp.com/?theme=photozoom" target="_blank">our demo</a>.</p>
			...
			<p>Photozoom Theme uses standard and custom widgets to quickly create your homepage.
